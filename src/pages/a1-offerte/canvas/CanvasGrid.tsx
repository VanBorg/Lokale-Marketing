...
export default function CanvasGrid({ thinLines, thickLines, canvasColors, theme }: CanvasGridProps) {
  return (
    <Layer listening={false}>
      ...
      <Line points={[-CENTER_CROSS_SIZE, 0, CENTER_CROSS_SIZE, 0]} stroke="#FF5C1A" strokeWidth={3} listening={false} />
      <Line points={[0, -CENTER_CROSS_SIZE, 0, CENTER_CROSS_SIZE]} stroke="#FF5C1A" strokeWidth={3} listening={false} />
    </Layer>
  );
}
