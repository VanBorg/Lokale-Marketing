...
type PendingSpecialRoom = { type: RoomType; name: string; length: number; width: number };
    ...
    <div className="flex flex-col h-full relative">
      ...
      <div className="flex flex-1 min-h-0">
        <PlattegrondCanvas
          ...
          onUndo={onUndo}
          onRedo={onRedo}
          pendingSpecialRoom={pendingSpecialRoom}
          pendingTargetRoomId={pendingTargetRoomId}
          onSelectTargetRoom={handleSelectTargetRoom}
          onCancelPendingSpecial={cancelPendingSpecial}
          onConfirmPlaceFinalized={confirmPlaceOnFinalizedTarget}
          onCancelPlaceFinalized={cancelPendingSpecial}
        />
